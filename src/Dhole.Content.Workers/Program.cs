...
using Dhole.Content.Workers.DependencyInjection;
using Dhole.Content.Workers.Security;

var contentRoot = Path.Combine(Directory.GetCurrentDirectory(), "src", "Dhole.Content.Workers");
...
builder.Services.AddContentWorker(builder.Configuration);
